...
var _createResponseData = _interopRequireDefault(require("./createResponseData"));
...
const localLighthouse = async ({
  ...
  const throttlingOverride = emulatedFormFactor === 'desktop' && !throttlingParam ? 'desktopDense4G' : throttlingParam; // the default config combined with overriding query params
  ...
  const rawResults = (0, _createResponseData.default)(result, emulatedFormFactor);
  return {
    url,
    localReport,
    report,
